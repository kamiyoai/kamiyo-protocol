...
static dark_forest_log_fn g_log_callback = NULL;
static dark_forest_log_level_t g_log_level = DARK_FOREST_LOG_LEVEL;
...
void dark_forest_log_set_level(dark_forest_log_level_t level) {
    ...
    if (level > DARK_FOREST_LOG_LEVEL) {
        level = DARK_FOREST_LOG_LEVEL;
    }
    g_log_level = level;
}
...
void dark_forest_log_write(dark_forest_log_level_t level, const char *file,
    ...
    if (level > DARK_FOREST_LOG_LEVEL) return;
...
void dark_forest_log_hex(dark_forest_log_level_t level, const char *label,
    ...
    dark_forest_log_write(level, __FILE__, __LINE__, "%s (%zu bytes): %s%s",
