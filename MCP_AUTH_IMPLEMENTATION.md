...
1. `~/project/Projekter/kamiyo/mcp/auth/jwt_handler.py` - JWT token management
2. `~/project/Projekter/kamiyo/mcp/auth/subscription.py` - Tier-based access control
3. `~/project/Projekter/kamiyo/mcp/auth/__init__.py` - Module exports
4. `~/project/Projekter/kamiyo/api/webhooks/mcp_processors.py` - Webhook integration
5. `~/project/Projekter/kamiyo/database/migrations/013_mcp_tokens.sql` - Database schema
6. `~/project/Projekter/kamiyo/tests/test_mcp_auth_integration.py` - Integration tests
7. `~/project/Projekter/kamiyo/.env.example` - Updated with MCP variables
8. `~/project/Projekter/kamiyo/MCP_AUTH_IMPLEMENTATION.md` - This document
