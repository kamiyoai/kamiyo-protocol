...
#### Modified Files ✓
- [x] `~/project/Projekter/kamiyo/pages/api/auth/[...nextauth].js`
...
- [x] `~/project/Projekter/kamiyo/pages/auth/signin.js`
...
#### New Files ✓
- [x] `~/project/Projekter/kamiyo/pages/api/auth/signup.js`
...
- [x] `~/project/Projekter/kamiyo/pages/auth/signup.js`
