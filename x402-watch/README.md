...
cp ~/project/Projekter/kamiyo/x402-watch/kamiyo.ts src/facilitators/
cp ~/project/Projekter/kamiyo/x402-watch/index.ts src/facilitators/
cp ~/project/Projekter/kamiyo/x402-watch/all.ts src/lists/
