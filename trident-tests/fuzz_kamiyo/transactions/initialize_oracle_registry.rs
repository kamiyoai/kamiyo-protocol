...
pub struct InitializeOracleRegistryTransaction {
    pub instruction: InitializeOracleRegistryInstruction,
}
...
impl TransactionHooks for InitializeOracleRegistryTransaction {
