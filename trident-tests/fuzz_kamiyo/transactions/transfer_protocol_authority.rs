...
pub struct TransferProtocolAuthorityTransaction {
    pub instruction: TransferProtocolAuthorityInstruction,
}
...
impl TransactionHooks for TransferProtocolAuthorityTransaction {
