...
pub struct RequestOracleWithdrawalTransaction {
    pub instruction: RequestOracleWithdrawalInstruction,
}
...
impl TransactionHooks for RequestOracleWithdrawalTransaction {
