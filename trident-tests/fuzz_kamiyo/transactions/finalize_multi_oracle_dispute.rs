...
pub struct FinalizeMultiOracleDisputeTransaction {
    pub instruction: FinalizeMultiOracleDisputeInstruction,
}
...
impl TransactionHooks for FinalizeMultiOracleDisputeTransaction {
