...
pub struct CompleteOracleWithdrawalTransaction {
    pub instruction: CompleteOracleWithdrawalInstruction,
}
...
impl TransactionHooks for CompleteOracleWithdrawalTransaction {
