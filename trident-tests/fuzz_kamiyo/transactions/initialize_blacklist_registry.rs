...
pub struct InitializeBlacklistRegistryTransaction {
    pub instruction: InitializeBlacklistRegistryInstruction,
}
...
impl TransactionHooks for InitializeBlacklistRegistryTransaction {
