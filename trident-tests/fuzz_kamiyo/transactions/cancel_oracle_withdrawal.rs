...
pub struct CancelOracleWithdrawalTransaction {
    pub instruction: CancelOracleWithdrawalInstruction,
}
...
impl TransactionHooks for CancelOracleWithdrawalTransaction {
