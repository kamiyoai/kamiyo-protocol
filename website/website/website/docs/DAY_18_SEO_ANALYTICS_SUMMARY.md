...
#### SEO Components
- **`~/project/Projekter/exploit-intel-platform/frontend/src/components/SEO/MetaTags.tsx`** (376 lines)
...
#### Analytics Modules
- **`~/project/Projekter/exploit-intel-platform/frontend/src/analytics/ga4.ts`** (599 lines)
...
- **`~/project/Projekter/exploit-intel-platform/frontend/src/analytics/analytics.ts`** (514 lines)
...
- **`~/project/Projekter/exploit-intel-platform/frontend/src/analytics/conversions.ts`** (484 lines)
...
- **`~/project/Projekter/exploit-intel-platform/frontend/src/analytics/gtm.ts`** (405 lines)
...
- **`~/project/Projekter/exploit-intel-platform/frontend/src/analytics/performance.ts`** (526 lines)
...
#### A/B Testing
- **`~/project/Projekter/exploit-intel-platform/frontend/src/experiments/abtest.ts`** (422 lines)
...
#### Landing Pages
- **`~/project/Projekter/exploit-intel-platform/frontend/src/pages/landing/HomePage.tsx`** (569 lines)
...
- **`~/project/Projekter/exploit-intel-platform/api/newsletter.py`** (400+ lines)
...
- **`~/project/Projekter/exploit-intel-platform/monitoring/frontend_metrics.py`** (400+ lines)
...
- **`~/project/Projekter/exploit-intel-platform/config/analytics_config.ts`** (280+ lines)
...
- **`~/project/Projekter/exploit-intel-platform/scripts/generate_sitemap.py`** (400+ lines)
...
- **`~/project/Projekter/exploit-intel-platform/frontend/public/robots.txt`** (90+ lines)
