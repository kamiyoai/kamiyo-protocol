        ...
        <div className="min-h-screen bg-black text-white">
            ...
            <section className="py-10 px-5 mx-auto max-w-[1400px]">
                ...
                <div className="border-dotted border-b border-cyan mb-12 pb-6">
                    <p className="font-light text-sm uppercase tracking-widest text-cyan mb-8">— &nbsp;DASHBOARD</p>
                    <h1 className="text-3xl md:text-4xl lg:text-5xl font-light leading-[1.25]">Security Intelligence</h1>
                ...
                <div className="mb-8 flex items-center justify-between flex-wrap gap-4">
                    <div className="flex items-center gap-6">
                        <button
                            ...
                            className="text-white text-sm border-b border-dotted border-cyan"
                        >
                            Dashboard
                        </button>
                        <button
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                    <div className="bg-black border border-dotted border-gray-500/25 p-6 hover:border-cyan transition-colors cursor-pointer"
