        ...
        <div className="min-h-screen bg-black text-white p-8">
            <div className="max-w-[1400px] mx-auto">
                ...
                <div className="mb-8 inline-block">
                    <div className="px-4 py-2 bg-gradient-to-r from-cyan to-magenta border-dotted">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                    {/* Daily Usage */}
                    <div className={`border border-dotted p-6 ${getUsageColor(dayPercentage)}`}>
                        ...
                        <div className="w-full bg-gray-800 border-dotted h-2 mb-2">
                            <div
                                className="bg-current h-2 border-dotted transition-all duration-500"
                    ...
                    {/* Hourly Usage */}
                    <div className={`border border-dotted p-6 ${getUsageColor(hourPercentage)}`}>
                        <div className="text-xs font-semibold uppercase tracking-wider mb-2 opacity-75">
                            Hourly Limit
                        </div>
                        <div className="text-3xl font-bold mb-2">
                    ...
                    {/* Per-Minute Usage */}
                    <div className={`border border-dotted p-6 ${getUsageColor(minutePercentage)}`}>
                        <div className="text-xs font-semibold uppercase tracking-wider mb-2 opacity-75">
                            Per-Minute Limit
                        </div>
                        <div className="text-3xl font-bold mb-2">
                ...
                {usageData.current_usage.endpoints && Object.keys(usageData.current_usage.endpoints).length > 0 && (
                    <div className="bg-obsidian border border-kamiyo-border border-dotted p-6 mb-8">
                                ...
                                .map(([endpoint, count]) => {
                                    ...
                                    return (
                                        <div key={endpoint} className="space-y-2">
                                            ...
                                            <div className="w-full bg-gray-800 border-dotted h-2">
                                                <div
                                                    className="bg-gradient-to-r from-cyan to-magenta h-2 border-dotted transition-all duration-500"
                ...
                {dayPercentage >= 75 && usageData.tier === 'free' && (
                    <div className="bg-gradient-to-r from-cyan/10 to-magenta/10 border border-cyan/50 border-dotted p-6 mb-8">
                        ...
                        <button
                            ...
                            className="px-6 py-3 bg-gradient-to-r from-cyan to-magenta text-white font-semibold border-dotted hover:opacity-90 transition"
                        >
                ...
                {/* Info Box */}
                <div className="bg-obsidian border border-kamiyo-border border-dotted p-6">
