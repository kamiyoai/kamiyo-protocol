"""
ERC-8004 Input Validation and Sanitization
Production-grade validation for all inputs
"""
...
def validate_tx_hash(tx_hash: str, field: str = "tx_hash") -> str:
    ...
    Returns:
        Normalized lowercase tx hash

    Raises:
        ValidationException: If tx hash is invalid
    """
...
def validate_chain(chain: str) -> str:
    ...
    Raises:
        ChainNotSupportedException: If chain not supported
    """
...
def validate_score(score: int) -> int:
    ...
    Raises:
        InvalidScoreException: If score out of range
    """
...
def validate_tag(tag: Optional[str], field: str = "tag") -> Optional[str]:
    ...
    Returns:
        Normalized lowercase tag or None

    Raises:
        ValidationException: If tag format invalid
    """
...
def validate_uri(uri: Optional[str], field: str = "uri") -> Optional[str]:
    ...
    Returns:
        Validated URI or None

    Raises:
        ValidationException: If URI invalid
    """
...
def validate_metadata_key(key: str) -> str:
    ...
    Raises:
        ValidationException: If key invalid
    """
...
def validate_agent_id(agent_id: int) -> int:
    ...
    Raises:
        ValidationException: If agent ID invalid
    """
...
def validate_registration_file(registration_file: Dict[str, Any]) -> Dict[str, Any]:
    ...
    Args:
        registration_file: Registration file to validate

    Returns:
        Validated registration file

    Raises:
        RegistrationFileInvalidException: If format invalid
    """
    errors = []
...
def sanitize_string(value: str, max_length: int) -> str:
    ...
    Raises:
        ValidationException: If string too long
    """
