...
**Main .env file location:** `~/project/Projekter/kamiyo/website/.env`

**For staging, copy and customize:**
```bash
cp ~/project/Projekter/kamiyo/website/.env.production.template .env.staging
```
...
- **Troubleshooting Guide:** `~/project/Projekter/kamiyo/website/docs/TROUBLESHOOTING.md`
