...
**File:** `~/project/Projekter/kamiyo/website/render.yaml`
...
- Remove `~/project/Projekter/kamiyo/website/render.yaml`
...
grep -r "kamiyo.db" ~/project/Projekter/kamiyo/website/
...
**New Documentation:**
- `~/project/Projekter/kamiyo/docs/DEPLOYMENT_RUNBOOK.md`
- `~/project/Projekter/kamiyo/docs/HOTFIX_PROCEDURE.md`
- `~/project/Projekter/kamiyo/docs/PRODUCTION_ENV_SETUP.md`
- `~/project/Projekter/kamiyo/scripts/validate_env.sh`
...
**Configuration Files:**
- `~/project/Projekter/kamiyo/render.yaml` (Root - USE THIS)
- `~/project/Projekter/kamiyo/website/render.yaml` (Duplicate - REMOVE)
- `~/project/Projekter/kamiyo/.env.example` (Environment template)

**Documentation Created:**
- `~/project/Projekter/kamiyo/docs/DEPLOYMENT_RUNBOOK.md`
- `~/project/Projekter/kamiyo/docs/PRODUCTION_ENV_SETUP.md`
- `~/project/Projekter/kamiyo/docs/HOTFIX_PROCEDURE.md`
- `~/project/Projekter/kamiyo/docs/DEPLOYMENT_AUDIT_REPORT.md`

**Scripts Created:**
- `~/project/Projekter/kamiyo/scripts/validate_env.sh` (Environment validation)

**API Files:**
- `~/project/Projekter/kamiyo/api/main.py` (Main API application)
- `~/project/Projekter/kamiyo/requirements.txt` (Python dependencies)

**Frontend Files:**
- `~/project/Projekter/kamiyo/website/package.json` (Node.js dependencies)
