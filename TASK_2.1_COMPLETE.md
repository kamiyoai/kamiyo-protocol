...
**File:** `~/project/Projekter/kamiyo/scripts/setup_solana_dev.sh`
...
**File:** `~/project/Projekter/kamiyo/scripts/verify_solana_setup.sh`
...
**File:** `~/project/Projekter/kamiyo/.env.example` (updated)
...
**File:** `~/project/Projekter/kamiyo/SOLANA_SETUP_README.md`
...
**File:** Created by verification script at `~/project/Projekter/kamiyo/solana-programs/Anchor.toml`
...
Next steps:
  1. Review Anchor workspace: cd ~/project/Projekter/kamiyo/solana-programs
...
```bash
ls -la ~/project/Projekter/kamiyo/solana-programs/
```
...
- ✅ **Anchor workspace initialized successfully**
  - Located at: `~/project/Projekter/kamiyo/solana-programs/`
