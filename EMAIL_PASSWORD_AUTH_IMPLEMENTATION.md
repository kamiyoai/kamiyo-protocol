...
#### `~/project/Projekter/kamiyo/pages/api/auth/[...nextauth].js`
**Changes:**
...
#### `~/project/Projekter/kamiyo/pages/auth/signin.js`
**Changes:**
...
#### `~/project/Projekter/kamiyo/pages/api/auth/signup.js`
...
#### `~/project/Projekter/kamiyo/pages/auth/signup.js`
...
### Automated Tests
Created test file: `~/project/Projekter/kamiyo/test_auth_implementation.js`
