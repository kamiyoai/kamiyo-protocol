#!/usr/bin/env npx tsx
/**
 * Test Hive agent signal submission on devnet
 */
...
import { HiveAgentClient } from './src/hive-agent';

async function main() {
  console.log('Initializing Hive agent...');
  ...
  const agent = new HiveAgentClient(connection, keypair, provider);
