/**
 * World Context Gatherer - gives Nika awareness of what's happening.
 *
 ...
 * tweet about current events -- makes Nika aware so she can choose
...
const log = createLogger('nika:world-context');
