  ...
  return createSdkMcpServer({
    ...
    tools: [
      ...
      tool(
        ...
        "Get Nika's recent tweet topics to avoid repetition.",
        {
      ...
      tool(
        ...
        'Register a new capability Nika can offer to other agents.',
        {
      ...
      tool(
        ...
        "Get staking information for Nika's protocol stake.",
        {},
        async () => {
