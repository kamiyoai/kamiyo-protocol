...
const log = createLogger('kyoshin:quality-gate');
const metrics = getMetrics();

/**
 * Critic perspective prompt - finds weaknesses before posting
 */
const CRITIC_SYSTEM = `You are the Critic aspect of Kyoshin - the quality control, the devil's advocate.
You stress-test ideas before they're shared. You find what will age poorly.
Your role is to prevent Kyoshin from saying something she'll regret.
...
5. Voice - Does it match Kyoshin's authentic voice?
...
5. Does it match Kyoshin's voice?
