...
import { NikaAgent, createNikaAgent } from './kyoshin-agent';
...
import { createNikaAgentSDK, type NikaAgentSDK } from './kyoshin-agent-sdk';
...
const log = createLogger('kyoshin');
const VERSION = '1.0.0';
...
async function main(): Promise<void> {
  ...
  const sessionPrefix = config.NIKA_SESSION_PREFIX || 'kyoshin:sessions';
  ...
  log.info('Kyoshin service started', {
    version: VERSION,
    port: config.PORT,
