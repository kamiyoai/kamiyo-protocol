...
import { KamiyoAgentRuntime } from './runtime.js';
import { KamiyoAgentServer } from './server.js';
...
async function main(): Promise<void> {
  ...
  try {
    const runtime = new KamiyoAgentRuntime(env);

    const server = env.KAMIYO_AGENT_HTTP_ENABLED
      ? new KamiyoAgentServer({
