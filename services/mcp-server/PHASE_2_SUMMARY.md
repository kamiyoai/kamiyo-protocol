...
**File:** `~/project/Projekter/kamiyo/mcp/tools/exploits.py`
...
**File:** `~/project/Projekter/kamiyo/mcp/tools/risk.py`
...
**File:** `~/project/Projekter/kamiyo/mcp/tools/monitoring.py`
...
**File:** `~/project/Projekter/kamiyo/mcp/server.py`
