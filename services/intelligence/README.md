...
1. **Edit the generator**: `~/project/Projekter/exploit-intel-platform/tools/generate_vuln_database.py`
...
3. **Run the generator**:
```bash
python3 ~/project/Projekter/exploit-intel-platform/tools/generate_vuln_database.py
```
...
- **File**: `~/project/Projekter/exploit-intel-platform/tools/cosmos_scanner.py`
...
### Move Scanner
- **File**: `~/project/Projekter/exploit-intel-platform/tools/move_scanner.py`
- **Detects**: Resource leaks, capability forgery, type confusion, signer auth, coin overflow
- **Chains**: Aptos, Sui

### Cairo Scanner
- **File**: `~/project/Projekter/exploit-intel-platform/tools/cairo_scanner.py`
- **Detects**: Felt overflow, hint manipulation, account abstraction, L1↔L2 messaging
- **Chains**: StarkNet (Cairo 0 and 1)

### Substrate Scanner
- **File**: `~/project/Projekter/exploit-intel-platform/tools/substrate_scanner.py`
...
Edit `~/project/Projekter/exploit-intel-platform/intelligence/database/exploit_database.json`:
...
```bash
# Test Cosmos scanner
python3 ~/project/Projekter/exploit-intel-platform/tests/test_cosmos_scanner.py
