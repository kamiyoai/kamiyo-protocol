...
const SWARMTEAMS_DIR = path.join(os.homedir(), '.hive');
...
export function loadIdentity(network: string): HiveIdentity | null {
  try {
...
export function getIdentitySecrets(identity: HiveIdentity): {
  ownerSecret: bigint;
