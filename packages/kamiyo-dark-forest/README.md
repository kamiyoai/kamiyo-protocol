...
```bash
npm install @kamiyo/dark-forest
```
...
```typescript
const prover = new DarkForestProver(config?: ProverConfig);
```
...
```typescript
DarkForestProver.isAvailable(): boolean
```
...
| Network | ZKReputationV2 (proxy) |
|---------|------------------------|
| Base | `0x87394c7a6D380b3a886704560E2A823CDA03c873` |
| Sepolia | `0xe21d25E8894f3c98Bc0bB7645B0f280081A41b93` |
