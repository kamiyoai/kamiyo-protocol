...
**Location:** `~/project/Projekter/kamiyo/scripts/validate_env.sh`
...
**Location:** `~/project/Projekter/kamiyo/render.yaml`
...
**Location:** `~/project/Projekter/kamiyo/.env.example`
...
- Location: `~/project/Projekter/kamiyo/docs/`
- Branch: `main`
...
A: Use the root one (`~/project/Projekter/kamiyo/render.yaml`). The one in website/ is a duplicate and should be removed.
