...
async def test_x402_connectivity():
    ...
    try:
        sys.path.insert(0, '~/project/Projekter/kamiyo')
...
def test_production_readiness():
    ...
    migration_file = '~/project/Projekter/kamiyo/database/migrations/002_x402_payments.sql'
...
async def run_all_tests():
    ...
    results_file = f"~/project/Projekter/kamiyo/payment_test_results_{datetime.utcnow().strftime('%Y%m%d_%H%M%S')}.json"
