...
describe('SwarmTeamsProver', () => {
  describe('generateIdentityCommitment', () => {
    ...
    it('should be deterministic', async () => {
      ...
      const c1 = await SwarmTeamsProver.generateIdentityCommitment(
        ownerSecret,
        agentId,
        registrationSecret
      );
      const c2 = await SwarmTeamsProver.generateIdentityCommitment(
        ownerSecret,
        agentId,
        registrationSecret
      );
  ...
  describe('generateNullifier', () => {
    ...
    it('should produce different nullifiers for different epochs', async () => {
      ...
      const n1 = await SwarmTeamsProver.generateNullifier(agentId, registrationSecret, BigInt(1));
      const n2 = await SwarmTeamsProver.generateNullifier(agentId, registrationSecret, BigInt(2));
    ...
    it('should be deterministic for same inputs', async () => {
      ...
      const n1 = await SwarmTeamsProver.generateNullifier(agentId, registrationSecret, epoch);
      const n2 = await SwarmTeamsProver.generateNullifier(agentId, registrationSecret, epoch);
  ...
  describe('generateVoteNullifier', () => {
    it('should generate 32-byte vote nullifier', async () => {
      ...
      const nullifier = await SwarmTeamsProver.generateVoteNullifier(
        agentId,
        registrationSecret,
        actionHash
      );
  ...
  describe('generateVoteCommitment', () => {
    ...
    it('should produce different commitments for different votes', async () => {
      ...
      const approve = await SwarmTeamsProver.generateVoteCommitment(true, voteSalt, actionHash);
      const reject = await SwarmTeamsProver.generateVoteCommitment(false, voteSalt, actionHash);
  ...
  describe('generateSignalCommitment', () => {
    it('should generate 32-byte signal commitment', async () => {
      ...
      const commitment = await SwarmTeamsProver.generateSignalCommitment(
        0, // signalType
        1, // direction
        75, // confidence
        50, // magnitude
    ...
    it('should be deterministic', async () => {
      ...
      const c1 = await SwarmTeamsProver.generateSignalCommitment(
        0, 1, 75, 50, BigInt(1000000000), secret, agentNullifier
      );
      const c2 = await SwarmTeamsProver.generateSignalCommitment(
        0, 1, 75, 50, BigInt(1000000000), secret, agentNullifier
      );
  ...
  describe('generateActionHash', () => {
    it('should generate 32-byte action hash', async () => {
      ...
      const hash = await SwarmTeamsProver.generateActionHash(0, actionData);
    ...
    it('should be deterministic', async () => {
      ...
      const h1 = await SwarmTeamsProver.generateActionHash(0, actionData);
      const h2 = await SwarmTeamsProver.generateActionHash(0, actionData);
    ...
    it('should produce different hashes for different action types', async () => {
      ...
      const h1 = await SwarmTeamsProver.generateActionHash(0, actionData);
      const h2 = await SwarmTeamsProver.generateActionHash(1, actionData);
