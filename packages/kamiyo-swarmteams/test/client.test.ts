...
import { SwarmTeamsClient, SWARMTEAMS_PROGRAM_ID } from '../src';

describe('SwarmTeamsClient', () => {
  describe('PDA Derivation', () => {
    it('should derive registry PDA consistently', () => {
      const [pda1, bump1] = SwarmTeamsClient.getRegistryPDA();
      const [pda2, bump2] = SwarmTeamsClient.getRegistryPDA();
    ...
    it('should derive agent PDA from identity commitment', () => {
      ...
      const [pda, bump] = SwarmTeamsClient.getAgentPDA(commitment);
    ...
    it('should derive different agent PDAs for different commitments', () => {
      ...
      const [pda1] = SwarmTeamsClient.getAgentPDA(commitment1);
      const [pda2] = SwarmTeamsClient.getAgentPDA(commitment2);
    ...
    describe('Identity Link PDAs', () => {
      it('should derive identity link PDA from ZK agent', () => {
        ...
        const [pda, bump] = SwarmTeamsClient.getIdentityLinkPDA(zkAgent);
      ...
      it('should derive different link PDAs for different agents', () => {
        ...
        const [pda1] = SwarmTeamsClient.getIdentityLinkPDA(agent1);
        const [pda2] = SwarmTeamsClient.getIdentityLinkPDA(agent2);
      ...
      it('should derive stake position PDA from staking program', () => {
        ...
        const [pda, bump] = SwarmTeamsClient.getStakePositionPDA(stakingProgramId, owner);
      ...
      it('should derive different stake PDAs for different owners', () => {
        ...
        const [pda1] = SwarmTeamsClient.getStakePositionPDA(stakingProgramId, owner1);
        const [pda2] = SwarmTeamsClient.getStakePositionPDA(stakingProgramId, owner2);
