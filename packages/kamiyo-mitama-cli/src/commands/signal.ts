...
import { provePrivateSignal } from '@kamiyo/kamiyo-mitama-prover';
import { storeSignal, getUnrevealedSignals, MitamaIdentity, getIdentitySecrets } from '../client/identity.js';
...
export async function handleSignal(
  ...
  try {
    ...
    console.log();
    showSuccess('Signal secrets stored in ~/.mitama/signals.json');
