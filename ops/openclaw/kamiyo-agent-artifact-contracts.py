...
def run() -> int:
    ensure_dirs()
    require_runtime = parse_bool(os.getenv('KYO_REQUIRE_KAMIYO_AGENT_RUNTIME'), True)
    ...
    checks = [
        ...
        ('kamiyo_agent_runtime', STATE_DIR / 'kamiyo-agent-runtime.json', require_runtime, validate_runtime_state),
