...
POLYMARKET_BRIDGE_PATH = BRIDGES_DIR / 'kamiyo-agent-polymarket-bridge.mjs'
LIMITLESS_BRIDGE_PATH = BRIDGES_DIR / 'kamiyo-agent-limitless-bridge.mjs'
...
def request_json(url: str, headers: dict[str, str] | None = None) -> Any:
    ...
    request = urllib.request.Request(
        ...
        headers={
            ...
            'User-Agent': 'kamiyo-agent-trading-exec/2.0',
            **(headers or {}),
        },
        method='GET',
    )
