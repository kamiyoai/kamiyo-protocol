...
def default_catalog() -> dict[str, Any]:
    return {
        'offers': [
            {
                'slug': 'kyoshin-x402-facilitator-pipeline',
                'name': 'Kyoshin x402 Facilitator Pipeline',
            ...
            {
                'slug': 'kyoshin-autonomous-operator-persona',
                'name': 'Kyoshin Autonomous Operator Persona',
            ...
            {
                'slug': 'kyoshin-revenue-ops-loop',
                'name': 'Kyoshin Revenue Ops Loop',
            ...
            {
                'slug': 'kyoshin-trust-layer-launch-kit',
                'name': 'Kyoshin Trust Layer Launch Kit',
            ...
            {
                'slug': 'kyoshin-24h-revenue-audit',
                'name': 'Kyoshin 24h Revenue Audit',
...
def request_json(method: str, path: str, payload: dict[str, Any] | None = None, query: dict[str, Any] | None = None) -> dict[str, Any]:
    ...
    request = urllib.request.Request(
        ...
        headers={
            ...
            'User-Agent': 'kyoshin-whop-catalog/1.0',
        },
        method=method.upper(),
    )
...
def create_or_update_product(existing: dict[str, Any] | None, offer: dict[str, Any]) -> tuple[dict[str, Any], str]:
    payload = {
        ...
        'metadata': {'tagline': offer['tagline'], 'source': 'kyoshin_whop_catalog'},
    }
