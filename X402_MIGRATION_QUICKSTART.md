...
| File | Purpose |
|------|---------|
| `~/project/Projekter/kamiyo/scripts/apply_x402_migration.sh` | Main migration script |
| `~/project/Projekter/kamiyo/scripts/verify_x402_migration.sh` | Verification script |
| `~/project/Projekter/kamiyo/database/migrations/002_x402_payments.sql` | SQL migration file |
| `~/project/Projekter/kamiyo/database/migrations/002_x402_payments_README.md` | Full documentation |
| `~/project/Projekter/kamiyo/X402_MIGRATION_QUICKSTART.md` | This quick start guide |
