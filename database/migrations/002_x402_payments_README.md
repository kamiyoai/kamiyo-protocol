...
Update `~/project/Projekter/kamiyo/api/x402/config.py`:
...
- **Migration Script:** `~/project/Projekter/kamiyo/scripts/apply_x402_migration.sh`
- **Migration SQL:** `~/project/Projekter/kamiyo/database/migrations/002_x402_payments.sql`
- **Config File:** `~/project/Projekter/kamiyo/api/x402/config.py`
- **Tests:** `~/project/Projekter/kamiyo/tests/x402/`
