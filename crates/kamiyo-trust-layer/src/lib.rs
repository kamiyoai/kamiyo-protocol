...
pub use model::{
    ...
    TrustDecision, TrustEvaluation, TrustEvent, TrustLayerSnapshot, TrustPolicy, TrustReceipt,
    BASE_SCORE, BASIS_POINTS_DENOMINATOR, INITIAL_POLICY_VERSION, MAX_CONTEXT_FIELD_LEN,
    MAX_EVENT_ID_LEN, MAX_EVENT_WEIGHT, MAX_SCORE,
};
