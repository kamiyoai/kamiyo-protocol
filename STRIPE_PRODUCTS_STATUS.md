...
The script (`~/project/Projekter/kamiyo/scripts/stripe/update_existing_products.sh`) will:
...
### Scripts Created
- **Update Script:** `~/project/Projekter/kamiyo/scripts/stripe/update_existing_products.sh`
- **Create Script:** `~/project/Projekter/kamiyo/scripts/stripe/create_mcp_products.sh`
