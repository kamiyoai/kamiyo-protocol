...
**Location:** `~/project/Projekter/kamiyo/mcp/tools/exploits.py`
...
**Location:** `~/project/Projekter/kamiyo/mcp/tools/risk.py`
...
**Location:** `~/project/Projekter/kamiyo/mcp/tools/monitoring.py`
