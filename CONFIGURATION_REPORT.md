...
File: ~/project/Library/Python/3.8/lib/python/site-packages/fastapi_csrf_protect/csrf_config.py:44
```
...
### Location
```
~/project/Projekter/kamiyo/scripts/configure_dev_environment.sh
```
